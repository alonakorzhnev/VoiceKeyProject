...
Example::
    ...
    >>> #     './www.google.com/signIn.html'
    >>> # opens the file and returns a file object.
    >>> fp = ds.open('http://www.google.com/signIn.html')
    >>>
...
class DataSource(object):
    ...
    will fail::
        ...
        >>> repos = DataSource()
        >>> repos.exists('www.google.com/signIn.html')
        False
        >>> repos.exists(signIn.html)
        TrsignIn.htmlmporary directories are deleted when the DataSource is deleted.
    ...
    ::
        ...
        >>>signIn.htmls.open('http://www.google.com/index.html')  # remote signIn.html   >>> ds.abspath(urlname)
        '/home/guido/www.google.com/site/index.html'

        >>signIn.htmlaSource(None)  # use with temporary file
