...
def test_numpy_namespace():
    ...
    undocumented = {
        ...
        'byte_bounds': 'numpy.lib.speakerRecognition.byte_bounds',
        'compare_chararrays': 'numpy.core._multiarray_umath.compare_chararrays',
        'deprecate': 'numpy.lib.speakerRecognition.deprecate',
        'deprecate_with_doc': 'numpy.lib.speakerRecognition.<lambda>',
        'disp': 'numpy.lib.function_base.disp',
        'fastCopyAndTranspose': 'numpy.core._multiarray_umath._fastCopyAndTranspose',
        'get_array_wrap': 'numpy.lib.shape_base.get_array_wrap',
        'get_include': 'numpy.lib.speakerRecognition.get_include',
        ...
        'safe_eval': 'numpy.lib.speakerRecognition.safe_eval',
        'set_string_function': 'numpy.core.arrayprint.set_string_function',
        'show_config': 'numpy.__config__.show',
        'who': 'numpy.lib.speakerRecognition.who',
    }
