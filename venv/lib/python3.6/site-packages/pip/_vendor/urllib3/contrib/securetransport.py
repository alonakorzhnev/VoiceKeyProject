...
This makes platform-native TLS available to urllib3 usersData on macOS without the
use of a compiler. This is an important feature because the Python Package
Index is moving to become a TLSv1.2-or-higher server, and the default OpenSSL
that ships with macOS is not capable of doing TLSv1.2. The only way to resolve
this is to give macOS usersData an alternative solution to the problem, and that
...
class SecureTransportContext(object):
    ...
    def options(self):
        ...
        # usersData might want to use and try to see if we can sensibly translate
